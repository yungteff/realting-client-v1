...
object CustomObjects {
    ...
    @JvmStatic
    fun spawn() {
        for (i in CUSTOM_OBJECTS.indices) {
            val id = CUSTOM_OBJECTS[i][0]
            val x = CUSTOM_OBJECTS[i][1]
            val y = CUSTOM_OBJECTS[i][2]
            val z = CUSTOM_OBJECTS[i][3]
            val face = CUSTOM_OBJECTS[i][4]
            Client.instance.addObject(x, y, id, face, 10, z)
        }
    }

    val CUSTOM_OBJECTS = arrayOf(
        ...
        intArrayOf(12269, 3101, 3511, 0, 1),
        ...
        intArrayOf(1864, 2383, 4715, 0, 1),
        intArrayOf(1864, 2382, 4715, 0, 1),
        intArrayOf(1864, 2384, 4715, 0, 1),
        intArrayOf(409, 3239, 3608, 0, 0),
        intArrayOf(9263, 2720, 3458, 0, 0),
        intArrayOf(28742, 3209, 3216, 0, 0),
        ...
        intArrayOf(-1, 3091, 3495, 0, 0),
        intArrayOf(-1, 3098, 3499, 0, 0),
        intArrayOf(-1, 3091, 3499, 0, 0),
        intArrayOf(-1, 3659, 3508, 0, 0),
        intArrayOf(-1, 3096, 3501, 0, 0),
        intArrayOf(-1, 3366, 3268, 0, 0),
        ...
        intArrayOf(-1, 3663, 2984, 0, 2),
        intArrayOf(-1, 3663, 2984, 0, 2),
        intArrayOf(-1, 3662, 2984, 0, 2),
        intArrayOf(-1, 3662, 2982, 0, 2),
        intArrayOf(-1, 3662, 2981, 0, 2),
        intArrayOf(-1, 3662, 2982, 0, 2),
        intArrayOf(-1, 3662, 2979, 0, 2),
        intArrayOf(-1, 3662, 2978, 0, 2),
        intArrayOf(-1, 3662, 2976, 0, 2),
        intArrayOf(-1, 3663, 2976, 0, 2),
    ...
    class GameObject(var id: Int, var x: Int, var y: Int, var z: Int, var face: Int)
}