...
final class Class37 {
	...
	final void method717(ByteBuffer class3_sub12, Class51 class51) {
		...
		if (i != 0) {
			anIntArray643[0] = class3_sub12.readUnsignedShort();
			anIntArray643[1] = class3_sub12.readUnsignedShort();
			int i_0_ = class3_sub12.readUnsignedByte();
			for (int i_1_ = 0; i_1_ < 2; i_1_++) {
				for (int i_2_ = 0; i_2_ < anIntArray646[i_1_]; i_2_++) {
					anIntArrayArrayArray644[i_1_][0][i_2_] = class3_sub12.readUnsignedShort();
					anIntArrayArrayArray647[i_1_][0][i_2_] = class3_sub12.readUnsignedShort();
				}
			}
			for (int i_3_ = 0; i_3_ < 2; i_3_++) {
				for (int i_4_ = 0; i_4_ < anIntArray646[i_3_]; i_4_++) {
					if ((i_0_ & 1 << i_3_ * 4 << i_4_) != 0) {
						anIntArrayArrayArray644[i_3_][1][i_4_] = class3_sub12.readUnsignedShort();
						anIntArrayArrayArray647[i_3_][1][i_4_] = class3_sub12.readUnsignedShort();
					} else {
