...
final class Class51 {
	...
	final void method800(ByteBuffer class3_sub12) {
		anInt857 = class3_sub12.readUnsignedByte();
		anIntArray854 = new int[anInt857];
		anIntArray853 = new int[anInt857];
		for (int i = 0; i < anInt857; i++) {
			anIntArray854[i] = class3_sub12.readUnsignedShort();
			anIntArray853[i] = class3_sub12.readUnsignedShort();
		}
	}

	final void method801(ByteBuffer class3_sub12) {
		anInt855 = class3_sub12.readUnsignedByte();
		anInt858 = class3_sub12.readInt();
		anInt856 = class3_sub12.readInt();
