...
final class Soundtrack {
	...
	final void method626(ByteBuffer class3_sub12) {
		...
		for (int i_0_ = 0; i_0_ < 10; i_0_++) {
			int i_1_ = class3_sub12.readtSmart();
			if (i_1_ == 0) {
				break;
			}
			anIntArray404[i_0_] = i_1_;
			anIntArray407[i_0_] = class3_sub12.method421();
			anIntArray414[i_0_] = class3_sub12.readtSmart();
		}
		anInt406 = class3_sub12.readtSmart();
		anInt418 = class3_sub12.readtSmart();
		anInt408 = class3_sub12.readUnsignedShort();
		anInt400 = class3_sub12.readUnsignedShort();
