...
public final class ObjectManager {
...

	{
		...
		try {
			...
			boolean osrs = stream.readUnsignedByte() == 1;
			int i_252_ = -1;
			for (;;) {
				int i_253_ = stream.readtSmart();
				if (i_253_ == 0) {
					break;
				}
				i_252_ += i_253_;
				...
				for (;;) {
					if (bool_255_) {
						int i_256_ = stream.readtSmart();
						if (i_256_ == 0) {
							break;
						}
						stream.readUnsignedByte();
					} else {
						int i_257_ = stream.readtSmart();
						if (i_257_ == 0) {
							break;
						}
						i_254_ += i_257_ - 1;
						...
						if (i_261_ > 0 && i_262_ > 0 && i_261_ < 103 && i_262_ < 103) {
							ObjectDefinition class46 = ObjectDefinition.forID(i_252_ + (osrs ? 70_000 : 0));
			...
			for (int l6 = -5; l6 < anInt146 + 5; l6++) {
				for (int i8 = 0; i8 < anInt147; i8++) {
					...
					if (k9 >= 0 && k9 < anInt146) {
						...
						if (l12 > 0) {
							if (l12 >= Flo.getCurrentCache().length) {
								l12 = Flo.getCurrentCache().length;
							}
							Flo flo = Flo.getCurrentCache()[l12 - 1];
					...
					if (i13 >= 0 && i13 < anInt146) {
						...
						if (i14 > 0) {
							if(i14 >= Flo.getCurrentCache().length)
								i14 = Flo.getCurrentCache().length;
							Flo flo_1 = Flo.getCurrentCache()[i14 - 1];
				...
				if (l6 >= 1 && l6 < anInt146 - 1) {
					...
					for (int k17 = -5; k17 < anInt147 + 5; k17++) {
						...
						if (k17 >= 1 && k17 < anInt147 - 1 && (!(lowDetail) || (aByteArrayArrayArray149[0][l6][k17] & 2) != 0 || (aByteArrayArrayArray149[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6) == anInt131)) {
							if (l < anInt145) {
								anInt145 = l;
							}
							...
							if (l18 > 0 || i19 > 0) {
								...
								if (l > 0) {
									...
									if (i19 > Flo.getOverlay().length) {
										i19 = Flo.getOverlay().length - 1;
									}
									if (i19 > 0 && !Flo.getOverlay()[i19 - 1].occlude) {
										flag = false;
									}
								...
								if (i19 == 0) {
									...
									Flo flo_2 = Flo.getOverlay()[i19 - 1];
									...
									if (floorTexture >= 0 && floorTexture <= 50) {
										...
										mapTexture = Rasterizer.anIntArray1482[method185(flo_2.hslToRgb, 96)];
										j23 = -2;
										floorTexture = -1;
									} else {
										j23 = method177(flo_2.hue, flo_2.saturation, flo_2.lumiance);
										mapTexture = Rasterizer.anIntArray1482[method185(flo_2.hslToRgb, 96)];
									}
	...
	private void method175(int y, WorldController worldController, CollisionMap class11, int type, int z, int x, int objectId, int face) {
		...
		int size2;
		if (face == 1 || face == 3) {
			size1 = class46.sizeY;//objectSizeY
			size2 = class46.sizeX;//objectSizeX
		} else {
			size1 = class46.sizeX;
			size2 = class46.sizeY;
		}
	...
	private void method181(int i, int j, ByteBuffer stream, int k, int l, int i1, int k1) {
		if (k >= 0 && k < 104 && i >= 0 && i < 104) {
			...
			do {
				...
				if (l1 <= 49) {
					aByteArrayArrayArray130[l][k][i] = stream.readtSignedByte();
				...
				do {
					...
					if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
						...
						if (j4 > 0 && k4 > 0 && j4 < 103 && k4 < 103) {
							...
							method175(k4, worldController, class11, l3, l, j4, l1 + (osrs ? 70_000 : 0), i4 + j1 & 3);
						}
					}
				} while (true);
			} while (true);
	...
	public final void method190(int i, CollisionMap aclass11[], int j, WorldController worldController, byte abyte0[]) {
		label0: {
			...
			boolean osrs = buffer.readUnsignedByte() == 1;
			int l = -1;

			do {
				int i1 = buffer.readtSmart();
				...
				do {
					...
					if (j3 > 0 && k3 > 0 && j3 < 103 && k3 < 103) {
						...
						method175(k3, worldController, class11, l2, j2, j3, l + (osrs ? 70_000 : 0), i3);
					}
				} while (true);
			} while (true);
		}
