...
public final class ByteBuffer extends NodeSub {
	...
	*/
	...
	public void encryptRSAContent() {
		 ...
		 */
		readBytes(currentPosition, 0, decodeBuffer);
	...
	public int readBits(int bitLength) {
		int k = bitPosition >> 3;
	...
	public void readByte(int value) {
	...
	public void readBytes(int len, int off, byte[] dest) {
	...
	public long readLong() {
		long msw = readIntLittleEndian() & 0xFFFFFFFFL;
		long lsw = readIntLittleEndian() & 0xFFFFFFFFL;
		return msw << 32 | lsw;
	}
	...
	public final int readTribyte(int value) {
		position += 3;
...
//		}
	...
	public int readUSmart2() {
		...
		while ((lastVal = readtSmart()) == 32767) {
			baseVal += 32767;
		}
