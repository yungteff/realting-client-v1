...
final class Class29 {
	...
	public void method325(ByteBuffer buffer) {
		...
		anInt538 = buffer.readIntLittleEndian();
		anInt539 = buffer.readIntLittleEndian();
		method326(buffer);
	}
	...
	public void method326(ByteBuffer buffer) {
		...
		for (int i = 0; i < anInt535; i++) {
			anIntArray536[i] = buffer.readUnsignedShort();
			anIntArray537[i] = buffer.readUnsignedShort();
		}
	}
