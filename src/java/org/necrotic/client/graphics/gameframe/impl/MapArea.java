...
**/
	...
	public boolean isHovering(Client client, ScreenMode screenMode) {
		...
		if (client.inSprite(false, client.compass, getOffSetX() + offsetX + (screenMode == ScreenMode.FIXED ? 6 : 5), getOffSetY() + (screenMode == ScreenMode.FIXED ? 8 : 5))) {
			return true;
		}

		if (client.mouseInCircle(getOffSetX() + offsetX + Client.cacheSprite[13].myWidth / 2, getOffSetY() + Client.cacheSprite[13].myHeight / 2, Client.cacheSprite[13].myWidth / 2)) {
			return true;
		}
	...
	public void loadOrbs(Client client, ScreenMode screenMode) {
		try {
			...
			if (client.inSprite(false, Client.cacheSprite[345], getxPos() - (GameFrame.getScreenMode() == ScreenMode.FIXED ? 2 - offsetX : 40), getyPos() + (GameFrame.getScreenMode() == ScreenMode.FIXED ? 46 : 2))) {
				Client.cacheSprite[344].drawSprite(getOffSetX() - (GameFrame.getScreenMode() == ScreenMode.FIXED ? 2 - offsetX : 40), getOffSetY() + (GameFrame.getScreenMode() == ScreenMode.FIXED ? 46 : 2));
			} else {
				Client.cacheSprite[345].drawSprite(getOffSetX() - (GameFrame.getScreenMode() == ScreenMode.FIXED ? 2 - offsetX : 40), getOffSetY() + (GameFrame.getScreenMode() == ScreenMode.FIXED ? 46 : 2));
			}
	...
	protected void render(Client client, ScreenMode screenMode) {
		if (isVisible()) {
			...
			if (client.anInt1021 == 2) {
				...
				client.compass.rotate(33, client.viewRotation, client.compassArray2, 256, client.compassArray1, 25, getOffSetY() + (screenMode == ScreenMode.FIXED ? 8 : 4), getOffSetX() + (screenMode == ScreenMode.FIXED ? 7 + offsetX : 5), 33, 25);
			 ...
			 * }
			 */
			client.miniMapRegions.rotate(152, i, client.mapImagePixelCutRight, 256 + client.minimapZoom, client.mapImagePixelCutLeft, playerPosY, getOffSetY() + (screenMode == ScreenMode.FIXED ? 10 : 5), getOffSetX() + (screenMode == ScreenMode.FIXED ? 31 + offsetX : 11), 152, playerPosX);
			client.compass.rotate(33, client.viewRotation, client.compassArray2, 256, client.compassArray1, 25, getOffSetY() + (screenMode == ScreenMode.FIXED ? 8 : 5), getOffSetX() + (screenMode == ScreenMode.FIXED ? 7 + offsetX : 5), 33, 25);
			...
			client.compass.rotate(33, client.viewRotation, client.compassArray2, 256, client.compassArray1, 25, getOffSetY() + (screenMode == ScreenMode.FIXED ? 8 : 4), getOffSetX() + (screenMode == ScreenMode.FIXED ? 7 + offsetX : 5), 33, 25);
			Client.cacheSprite[screenMode == ScreenMode.FIXED ? 14 : 13].drawSprite(getOffSetX(), getOffSetY() - (screenMode == ScreenMode.FIXED ? 0 : 1));

			/*
			 * Globe
			 */
			if (screenMode != ScreenMode.FIXED) {
				Client.cacheSprite[461].drawSprite(getOffSetX() + 125 + offsetX, getOffSetY() + 128);
			}
			if (client.inSprite(false, Client.cacheSprite[456], getxPos() + (screenMode != ScreenMode.FIXED ? 130 : 6), getyPos() + (screenMode != ScreenMode.FIXED ? 132 : 124))) { //handleglobe
				Client.cacheSprite[457].drawSprite(getOffSetX() + offsetX + (screenMode != ScreenMode.FIXED ? 130 : 6), getOffSetY() + (screenMode != ScreenMode.FIXED ? 132 : 124));
			} else {
				Client.cacheSprite[456].drawSprite(getOffSetX() + offsetX + (screenMode != ScreenMode.FIXED ? 130 : 6), getOffSetY() + (screenMode != ScreenMode.FIXED ? 132 : 124));
			}
			...
			if (client.mouseX >= Client.clientWidth - Client.cacheSprite[342].myWidth && client.mouseX < Client.clientWidth && client.mouseY >= 0 && client.mouseY <= Client.cacheSprite[342].myHeight) {
				Client.cacheSprite[342].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0);
			} else {
				Client.cacheSprite[341].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0);
			}
			...
			if (Configuration.MONEY_POUCH_ENABLED) {
				...
				if (client.inSprite(false, Client.cacheSprite[559], x, fixed ? 82 : 48 + y) || client.inSprite(false, Client.cacheSprite[565], getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82)) {
					Client.cacheSprite[564].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82);
				} else {
					//Client.cacheSprite[566].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82);
				}
			/*} else {
				if (client.inSprite(false, Client.cacheSprite[566], getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82)) {
					Client.cacheSprite[564].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82);
			...
			if (Client.tabID == 14) {
				Client.cacheSprite[343].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0);
			}

			if (client.inSprite(false, Client.cacheSprite[458], getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 128 : 204), 0)) {
				Client.cacheSprite[459].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 128 : 204), 0);
			} else {
				Client.cacheSprite[458].drawSprite(getOffSetX() + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 128 : 204), 0);
			}

			DrawingArea.drawPixels(3, 76 + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 4 : 8) + getOffSetY(), 76 + offsetX + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 9 : 29) + getOffSetX(), 0xffffff, 3);

			if(screenMode == ScreenMode.FIXED && client.menuOpen){
				client.drawMenu(516, 0);
			}
