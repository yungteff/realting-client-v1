...
public class MobDefinitionCustom {

    public static void do667(MobDefinition definition) {
        switch (definition.id) {
            ...
            case 5529:
                ...
                if(definition.id == 6873) { //Yak summon
            ...
            case 2000:
                ...
                MobDefinition ven= MobDefinition.get(2035);
            ...
            case 2001:
                ...
                definition.actions = new String[] {null, "Attack", null, null, null};
                MobDefinition scor= MobDefinition.get(107);
            ...
            case 2006:
                ...
                definition.actions = new String[] {null, "Attack", null, null, null};
                MobDefinition vet= MobDefinition.get(90);
            ...
            case 2007:
                ...
                definition.actions = new String[] {null, "Attack", null, null, null};
                MobDefinition eld= MobDefinition.get(3847);
                definition.npcModels = new int[1];
            ...
            case 2008:
                ...
                definition.actions = new String[] {null, "Attack", null, null, null};
                MobDefinition cave= MobDefinition.get(3847);
                definition.npcModels = new int[1];
            ...
            case 2009:
                ...
                MobDefinition callisto= MobDefinition.get(105);
		...
		case 1385:
            ...
            case 4657:
                ...
                break;
            case 605:
                definition.actions = new String[] {"Talk-to", null, "Vote Shop", null, "Loyalty Titles"};
                break;
            case 8591:
            ...
            case 8022:
            case 8028:
                String color = definition.id == 8022 ? "Yellow" : "Green";
            ...
            case 2579:
                ...
                definition.description = ("One of " + Configuration.CLIENT_NAME + "'s skillful citizens.").getBytes();
            ...
            case 2676:
                ...
                break;
            case 494:
                definition.actions = new String[] {"Bank", null, null, null, null};
                break;
            case 1360:
