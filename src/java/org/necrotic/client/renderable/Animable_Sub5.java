...
public final class Animable_Sub5 extends Animable {
	...
	private ObjectDefinition method457() {
		ObjectDefinition definition = ObjectDefinition.forID(anInt1610);
		int i = -1;
		if (anInt1601 != -1 && anInt1601 < VarBit.getCache(definition.dataType).length) {
			VarBit varBit = VarBit.getCache(definition.dataType)[anInt1601];
